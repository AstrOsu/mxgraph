...
Actions.prototype.init = function()
{
	...
	this.addAction('export...', function() { ui.showDialog(new ExportDialog(ui, false).container, 300, 230, true, true); });
	this.addAction('fancyExport...', function() { ui.showDialog(new ExportDialog(ui, true).container, 300, 230, true, true); });
